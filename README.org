...
* Lecturas del year 2026

** Septiembre 2026

+ [[https://huggingface.co/blog/ServiceNow/mosaicleaks][MosaicLeaks: Can your research agent keep a secret?]] #Privacy
+ [[https://arxiv.org/abs/2606.05107][2606.05107 Who Needs Labels? Adapting Vision Foundation Models With the Metadata You Already Have]] #DomainAdaptation
+ [[https://huggingface.co/blog/Hcompany/neomme][NeoMME: an efficient Multimodal-native and Multilingual Encoder]] #VisualRAG #MultiModalEmbedding
+ [[https://huggingface.co/blog/train-to-paint-with-code][Training a coding model to paint watercolours with TRL and OpenEnv]] #ReinforcementLearning #TRL
+ [[https://x.com/SergioPaniego/article/2074863503312044499][Distillation in 2026 (so far): which frontier models use it and how | Sergio Paniego (@SergioPaniego) on X]] #Distillation
+ [[https://www.rtve.es/noticias/20260622/mapa-inteligencia-artificial-espana/17126158.shtml][De la A a la Z, mapa de la inteligencia artificial en España]] #Referentes
+ [[https://huggingface.co/blog/allenai/olmoearth-infrastructure][The OlmoEarth Platform: Geospatial inference at planetary scale]] #Adrian #Jaime
+ [[https://www.liquid.ai/blog/lfm2-5-retrievers][LFM2.5 Retrievers: Bi-directional LFMs for Fast Multilingual Search | Blog | Liquid AI]] #RAG #Pablo
+ [[https://huggingface.co/blog/LiquidAI/lfm2-5-encoders][LFM2.5-Encoders for Fast Long-Context Inference on CPU]] #Encoder #PII #Mirari #CienciaEnClaro
+ [[https://chatgpt.com/share/6a9ed8e0-249c-83eb-a1a3-7e7fc06a73a1][ChatGPT - Explicación del spellchecker]] #Mapi #Mirari
+ [[https://huggingface.co/blog/hugging-science/run-aifs-yourself][ECMWF&#39;s AI forecasting model is open source: now let&#39;s make it easy to run.]] #WeatherForecasting
+ [[https://huggingface.co/blog/allenai/discoformer][DiScoFormer: One transformer for density and score, across distributions]] #Diffusion
+ [[https://huggingface.co/blog/daya-shankar/open-source-llm-models-to-run-locally][The Best Open Source and Open-Weight LLM Models to Run Locally in 2026]] #OpenSource #LocalModels
+ [[https://huggingface.co/blog/Qdrant/fineweb-10b-release][Internet-Scale Knowledge Retrieval: A Novel Vector Search Dataset at 10B Scale]] #Database
+ [[https://huggingface.co/blog/ibm-research/cuga-apps][Build real agentic apps using CUGA: two dozen working examples on a lightweight harness]] #Agents
+ [[https://dl.acm.org/doi/10.1145/3236784][Ready, set, verify! applying hs-to-coq to real-world Haskell code (experience report)]] #Verification #Coq
+ [[https://dl.acm.org/doi/full/10.1145/3703155][A Survey on Hallucination in Large Language Models: Principles, Taxonomy, Challenges, and Open Questions]] #Pablo #Hallucinations
+ [[https://huggingface.co/blog/MultiverseComputingCAI/safety-for-whom][Safety for Whom? Refusing the Right Subset of a Topic, Not the Whole Topic]] #Pablo #PrevenIA
+ [[https://huggingface.co/blog/ibm-research/ibm-releases-sota-granite-time-series][IBM releases SOTA Granite Time Series PatchTST-FM-r2 model with commercial-friendly license]] #TimeSeries
+ [[https://arxiv.org/abs/2307.05080][2307.05080 Estimating label quality and errors in semantic segmentation data via any model]] #Joaquin #DataPriorization
+ [[https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5877662][On the Slow Death of Scaling]]
+ [[https://pub.sakana.ai/pc-alm/][Augmented Lagrangian Predictive Coding: training 1000-layer networks without backpropagation]] #Learning
+ [[https://magazine.sebastianraschka.com/p/gpt-6-astra-looped-transformers-and][GPT-6 Astra, Looped Transformers, and Hidden Reasoning]] #Transformers
+ [[https://arxiv.org/abs/2605.20520][2605.20520 Open-World Evaluations for Measuring Frontier AI Capabilities]] @s #Evaluation
+ [[https://huggingface.co/spaces/HuggingFaceM4/encoder-free-vlm][Encoder-Free VLM - a Hugging Face Space by HuggingFaceM4]] #VLM
+ [[https://research.google/blog/toolgrad-efficient-tool-use-dataset-generation-with-textual-gradients/][ToolGrad: Efficient tool-use dataset generation with textual &quot;gradients&quot;]] #Júlia #Dataset
+ [[https://arxiv.org/abs/2512.18176][2512.18176 Atlas is Your Perfect Context: One-Shot Customization for Generalizable Foundational Medical Image Segmentation]] #SemanticSegmentation #Joaquin
+ [[https://arxiv.org/abs/2607.04249][2607.04249 Beyond Random Sampling: Distribution-Aware Alignment for Semi-Supervised Medical Image Segmentation]] #SemanticSegmentation #SemiSupervised #Joaquin
+ [[http://paperswithcode.co/paper/2602.23339][Retrieve and Segment: Are a Few Examples Enough to Bridge the Supervision Gap in Open-Vocabulary Segmentation? (arXiv:2602.23339) | Papers with Code]] #SemanticSegmentation
+ [[https://journals.plos.org/digitalhealth/article?id=10.1371/journal.pdig.0001661][Atrial fibrillation and retinal imaging-based oculomics: A cross-sectional and longitudinal analysis of two large cohorts | PLOS Digital Health]] #Retina
+ [[https://arxiv.org/abs/2607.17693][2607.17693 Memory-Supported Synergistic Adaptation for Training-Free Test-Time Medical Image Segmentation]] #VLM #Segmentation #David
+ [[https://psych.ukp-lab.de/][Home - NLP for Mental Health at UKP]] #Pablo #MentalHealth
+ [[https://sepln2026.org/wp-content/uploads/2026/07/21_ETEL.pdf][ETEL: A Lightweight System for Readability Assessment in Basque]] #Readability #Mirari
+ [[https://sepln2026.org/wp-content/uploads/2026/08/71_Machinne_Translation.pdf][Machine Translation between Uruguayan Sign Language (LSU) Glosses and Spanish]] #LSEAvatar
+ [[https://sepln2026.org/wp-content/uploads/2026/07/87_The_First_Spoken.pdf][The First Spoken Spanish Treebank in Universal Dependencies: Annotation, Distributional Analysis, and Parsing Evaluation]] #Sara
+ [[https://arxiv.org/abs/2608.06292][2608.06292 NeSy-RAG: Neuro-Symbolic RAG for Explainable Question Answering]] #Pablo #PrevenIA #AtomicFacts
+ [[https://fmplaza.github.io/][Flor Plaza]] #Pablo
+ [[https://typesafe.ai/blog/introducing-system-one-models-and-jev][Introducing System One Models &amp; Jev - TypeSafe AI Blog]] #DecissionSuport #Pablo #Mirari #CienciaEnClaro
+ [[https://archerhume.com/posts/jevs-architecture-unmasked][Jev’s Architecture Unmasked — archerhume]] #Jev
+ [[https://machinelearningmastery.com/anomaly-detection-with-isolation-forest-and-kernel-density-estimation/][Anomaly Detection with Isolation Forest and Kernel Density Estimation - MachineLearningMastery.com]] #AnomalyDetection
+ [[https://arxiv.org/abs/2607.05147][2607.05147 DSpark: Confidence-Scheduled Speculative Decoding with Semi-Autoregressive Generation]] #SpeculativeDecoding
+ [[https://csprofkgd.github.io/Computer-Vision-Coursepage/][A Visual and Technical Journey Into Computer Vision]] #Teaching
+ [[https://csprofkgd.github.io/deep-learning-coursepage/][A Visual and Technical Journey Into Deep Learning]] #Teaching
+ [[https://laya.convaiinnovations.com/][Laya — 33ms Multilingual System 1 Decision Engine with Calibrated Probabilities]] #ZeroShotClassification #Pablo #Mirari
+ [[https://huggingface.co/blog/evaleval-aisi][How UK AISI and EvalEval Are Making Benchmark Results Reproducible]] #Júlia #Evaluatino
+ [[https://www.sciencedirect.com/science/article/pii/S2643651525001268?via%3Dihub][Nondestructive individual tree aboveground biomass estimation using a hierarchical Bayesian approach in combination with individual tree competition indices]] #Adrian #DireccionGeneral
+ [[https://www.technologyreview.com/2026/09/22/1144867/dont-be-fooled-summer-ai-hype/][Don’t be fooled by this summer of AI hype]]
+ [[https://www.technologyreview.com/2026/09/22/1144867/dont-be-fooled-summer-ai-hype/][Don’t be fooled by this summer of AI hype]] #CIAIS
+ [[https://huggingface.co/blog/nvidia/nemotron-diarization][**Know Who Spoke When: Build Real-Time, Multi-Speaker AI with NVIDIA Nemotron 3 Diarization**]] #Diarization #Sara
+ [[https://contrastive-lm.notion.site/][Notion]] #Jev #DecissionSupport
+ [[https://ieeexplore.ieee.org/document/11430670][Average Calibration Losses for Reliable Uncertainty in Medical Image Segmentation]] #Calibration #Segmentation
+ [[https://arxiv.org/html/2409.00924v1][MedSAM-U: Uncertainty-Guided Auto Multi-Prompt Adaptation for Reliable MedSAM]] #UnncertaintyCuantification #MedSAM
+ [[https://arxiv.org/abs/2511.19046][2511.19046 MedSAM3: Delving into Segment Anything with Medical Concepts]] #MedSAM
+ [[https://arxiv.org/abs/2505.05049][2505.05049 UncertainSAM: Fast and Efficient Uncertainty Quantification of the Segment Anything Model]] #UncertaintyQuantification #SAM
+ [[https://arxiv.org/html/2609.26550v1][JEV-as-a-Judge: Accept When Confident, Escalate When Unsure]] #Evaluation #Jev
+ [[https://huggingface.co/blog/LiquidAI/lfm2-5-vl-dspark][Accelerating vision-language models with LFM2.5-VL-DSpark]] #VLM #Decoding
+ [[https://papers.miccai.org/miccai-2025/0877-Paper1739.html][SUGFW: A SAM-based Uncertainty-guided Feature Weighting Framework for Cold Start Active Learning | MICCAI 2025 - Open Access]] #SAM #UncertaintyQuantification
+ [[https://papers.miccai.org/miccai-2026/0840-Paper4232.html][Quality-Guided Semi-supervised Learning for Medical Image Segmentation | MICCAI 2026 - Open Access]] #SemiSupervisedLearning #Joaquin #Adrian
+ [[https://papers.miccai.org/miccai-2026/0835-Paper0846.html][PseudoRET: A General Retinal Segmentation Framework with Multi-target Pseudo Embeddings | MICCAI 2026 - Open Access]] #OPTtina #Segmentation


** Agosto 2026

+ [[https://huggingface.co/OpenMOSS-Team/MOSS-Transcribe-Diarize][OpenMOSS-Team/MOSS-Transcribe-Diarize · Hugging Face]] #Transcription #Diarization
+ [[https://huggingface.co/blog/MultiverseComputingCAI/efficient-knowledge-distillation][Making Knowledge Distillation Cheap Enough to Run at Scale]] #Distillation
+ [[https://huggingface.co/blog/muse-glimmer][Meta is back with Muse Glimmer: local, agentic, multimodal, and open source]] #MLLM
+ [[https://huggingface.co/blog/asr-benchmark-optimization][Measuring benchmark optimization in speech recognition]] #Benchmarks #ASR
+ [[https://queue.acm.org/detail.cfm?id=3712057][Systems Correctness Practices at AWS]] #FormalMethods
+ [[https://huggingface.co/blog/nvidia/magpie-tts-multilingual-voice-agents][Build Low-Latency Multilingual Voice Agents: Open Weights &amp; Full Deployment Control with NVIDIA Magpie TTS]] #TTSS
+ [[https://huggingface.co/blog/ibm-research/altk-evolve][ALTK‑Evolve: On‑the‑Job Learning for AI Agents]] #Memory #Agents
+ [[https://huggingface.co/blog/ibm-research/altk-evolve-sldd][Thinking of ACE? We Can Do It with Fewer Tokens]] #Memory #Agents
+ [[https://huggingface.co/blog/allenai/olmoearth-embeddings][Introducing OlmoEarth embeddings: Custom embedding exports from OlmoEarth Studio for downstream analysis]] #Jaime #Adrian #Embeddings
+ [[https://huggingface.co/blog/icml-2026-open-reproductions][What We Learned by Reproducing 2,200 papers from ICML]] #Reproducibility #Agents
+ [[https://huggingface.co/blog/state-of-open-models-summer-2026][State of Open Models: Summer 2026 Observations]] #OpenModels
+ [[https://cekrem.github.io/posts/programming-as-theory-building-naur/][Programming as Theory Building: Why Senior Developers Are More Valuable Than Ever · cekrem.github.io]] #TheoryBuilding
+ [[https://research.google/blog/agenthands-generating-interactive-hand-gestures-for-spatially-grounded-agent-conversations-in-xr/][AgentHands: Generating interactive hand gestures for spatially grounded agent conversations in XR]] #VirtualReality
+ [[https://research.google/blog/empty-shelves-or-lost-keys-recall-is-the-bottleneck-for-parametric-factuality/][Empty shelves or lost keys? Recall is the bottleneck for parametric factuality]] #Facts #Pablo
+ [[https://huggingface.co/blog/train-multi-vector-encoder][Training and Finetuning Multi-Vector Embedding Models with Sentence Transformers]] #Embeddings #Pablo
+ [[https://realpython.com/quantum-computing-basics/][Quantum Computing Basics With Qiskit – Real Python]] #QuantumComputing
+ [[https://pageindex.ai/blog/pageindex-intro][PageIndex: Next-Generation Vectorless, Reasoning-based RAG]] #LLMs #Pablo #Retrieval
+ [[https://www.iic.uam.es/noticias/metricas-para-construir-inteligencia-artificial-fiable/][Métricas para construir una inteligencia artificial fiable - IIC]] #Fiabilidad #Metricas


** Julio 2026

+ [[https://huggingface.co/blog/cerebras-gemma4-voice-ai][Hugging Face and Cerebras bring Gemma 4 to real-time voice AI]] #Speech2Speech
+ [[https://huggingface.co/blog/Dharma-AI/why-specialization-is-inevitable][Why Specialization Is Inevitable]] #Specialization
+ [[https://research.google/blog/introducing-tabfm-a-zero-shot-foundation-model-for-tabular-data/][Introducing TabFM: A zero-shot foundation model for tabular data]] #TabularData
+ [[https://huggingface.co/blog/eee-community-evals][Featuring Every Eval Ever Results on Hugging Face Model Pages]] #Evaluation #LeaderBoards
+ [[https://erc.europa.eu/news-events/magazine-article/why-values-not-just-rules-are-needed-stop-ethics-dumping][Why values – not just rules – are needed to stop ethics dumping |ERC]] #CIAIS
+ [[https://inferenceengineering.tech/chapters/inference/][Ch 0: The Three Layers of Inference | Inference Engineering]] #InferenceEngineering
+ [[https://blog.neurips.cc/2026/03/23/introducing-the-evaluations-datasets-track-at-neurips-2026/][Introducing the Evaluations &#038; Datasets Track at NeurIPS 2026 &#8211; NeurIPS Blog]] #Júlia
+ [[https://www.cs.princeton.edu/~arvindn/talks/icml-2026-annotated-slides/][What will be left for us to work on? — ICML 2026 keynote]] #IA
+ [[https://huggingface.co/blog/hugging-science/doctobert-cookbook][Putting DoctoBERT to Work: A Practical Guide]] #MedicalEncoder #French #Leo
+ [[https://huggingface.co/blog/bofenghuang/doctobert-fr-release][Where Does the Signal Live? &lt;br&gt; A Web Data Recipe for Medical Encoder Pretraining]] #DatasetCuration #Medicine
+ [[https://huggingface.co/blog/nvidia/open-data-for-agents][Data for Agents]] #Datasets
+ [[https://x.com/SergioPaniego/article/2073066275819991472][A brief history of distillation in AI]] #Distillation
+ [[https://opencv.org/opencv-5/][OpenCV 5 Deep Dive: A New Foundation for Computer Vision]] #OpenCV #ComputerVision
+ [[https://huggingface.co/blog/real-world-voiceeq][Introducing Real World VoiceEQ: Measuring the human quality of voice AI]] #Audio
+ [[https://huggingface.co/blog/nvidia/scale-diffusers-finetuning-nemo-automodel][Fine-tune video and image models at scale with NVIDIA NeMo Automodel and 🤗 Diffusers]] #Text2Image #Text2Video


** Junio 2026

+ [[https://huggingface.co/blog/lbourdois/introduction-to-trimming][Introduction to Trimming ✂]] #Pruning
+ [[https://simax.media/][SiMAX | Home - SiMAX]] #LSEAvatar
+ [[https://evoc.readthedocs.io/en/latest/index.html][EVōC: Embedding Vector Oriented Clustering &mdash; EVoC 0.1.0 documentation]] #Clustering #Embedding
+ [[https://huggingface.co/blog/nvidia/nemotron-3-5-content-safety][Nemotron 3.5 Content Safety: Customizable Multimodal Safety for Global Enterprise AI]] #Pablo #Safety
+ [[https://huggingface.co/blog/allenai/olmoearth-v1-1][OlmoEarth v1.1: A more efficient family of Earth observation models]] #Adrian #Jaime
+ [[https://huggingface.co/blog/ettin-reranker][Introducing the Ettin Reranker Family]] #Reranker #Pablo
+ [[https://huggingface.co/blog/ibm-granite/granite-embedding-multilingual-r2][Granite Embedding Multilingual R2: Open Apache 2.0 Multilingual Embeddings with 32K Context — Best Sub-100M Retrieval Quality]] #Pablo #Embeddings
+ [[https://rawalkhirodkar.github.io/sapiens2/][Sapiens2]] #Human #LSEAvatar
+ [[https://flashml-org.github.io/][FlashLib: Bringing Flash Magic to Classical Machine Learning Operators]] #ClassicalML #CUDA
+ [[https://x.com/sairahul1/article/2058464422306443766][AI Agents: The Complete Course]]
+ [[https://huggingface.co/blog/agent-glossary][Harness, Scaffold, and the AI Agent Terms Worth Getting Right]] #Agents
+ [[https://pub.sakana.ai/kame/][Two Heads Are Better Than One:]] Async Knowledge Injection for Speech AI with Tandem Architecture#Speech2Speech
+ [[https://www.sciencedirect.com/science/article/pii/S0952197626012819][Advancing Spanish clinical language understanding through domain-adaptive pretraining and new open clinical resources]] #Leo
+ [[https://link.springer.com/article/10.1007/s10916-026-02414-0][Client Challenge]] #OPTRetina
+ [[https://paperswithcode.co/paper/2604.18811][Rethinking Dataset Distillation: Hard Truths about Soft Labels | Papers with Code]] #DatasetPruning #Joaquin
+ [[https://research.google/blog/a-decoder-only-foundation-model-for-time-series-forecasting/][A decoder-only foundation model for time-series forecasting]] #TimeSeriesForecasting
+ [[https://huggingface.co/blog/peft-beyond-lora][Beyond LoRA: Can you beat the most popular fine-tuning technique?]] #FineTuning
+ [[https://huggingface.co/blog/is-it-agentic-enough][Is it agentic enough? Benchmarking open models on your own tooling]] #Agents #Tools
+ [[https://huggingface.co/blog/PaddlePaddle/pp-ocrv6][PP-OCRv6 on Hugging Face: 50-Language OCR from 1.5M to 34.5M Parameters]] #OCR
+ [[https://huggingface.co/blog/ffasr-leaderboard][Introducing the FFASR Leaderboard: Benchmarking ASR in the Real World]] #ASR
+ [[https://huggingface.co/blog/nvidia/accelerating-fine-tuning-nvidia-nemo-automodel][Accelerating Transformers Fine-Tuning with NVIDIA NeMo AutoModel]] #LLMs #MOE


** Mayo 2026

+ [[https://pub.sakana.ai/kame/][Async Knowledge Injection for Speech AI with Tandem Architecture]] #Speech2Speech
+ [[https://victoryepes.blogs.upv.es/2026/05/04/auditar-la-ia-y-no-solo-usarla/][El «sesgo hacia el error»: por qué el futuro de la ingeniería depende de auditar la IA (y no solo de usarla) - El blog de Víctor Yepes]] #Educación
+ [[https://docs.google.com/document/d/179uI7VYEbm9KbN0HBlktjX3x6Mc5Pj-HYtegfvziqtM/edit?tab=t.0][NeurIPS Evaluations and Datasets: Guidelines for filling RAI attributes - Documentos de Google]] #Júlia #Datasets
+ [[https://dl.acm.org/doi/10.1145/3650203.3663326][Croissant: A Metadata Format for ML-Ready Datasets]] #Datasets #Júlia
+ [[https://github.com/lyhyl/Reti-Pioneer][GitHub - lyhyl/Reti-Pioneer: AI Framework for Multidisease Detection via Retinal Imaging · GitHub]] #OPTetina #FoundationalModel
+ [[https://erictopol.substack.com/p/the-paradox-of-medical-ai-implementation][The Paradox of Medical AI Implementation]]
+ [[https://www.youtube.com/watch?v=dWk4Rq-2esA][Post-Entrenamiento de LLMs, Sergio Paniego @Hugging Face | #HackathonSomosNLP 2026 - YouTube]] #Pablo #PostEntrenamiento #Júlia
+ [[https://isaacflath.com/writing/QuantizationFundamentalsForMultiVectorRetrieval][Quantization for ColBERT | Isaac Flath]] #Quantization #MultiEmbedding #Retrieval
+ [[https://huggingface.co/blog/nvidia/nemotron-labs-diffusion][Towards Speed-of-Light Text Generation with Nemotron-Labs Diffusion Language Models]] #Difusion #LLMs
+ [[https://airesistlist.org/][The AI Resist List]] #CIAIS


** Abril 2026

+ [[https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/][Gemma 4: Our most capable open models to date]] #Gemma #Pablo
+ [[https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-gemma-4][A Visual Guide to Gemma 4]]
+ [[https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-gemma-4][A Visual Guide to Gemma 4]] #Pablo #Gemma #Elena
+ [[https://research.google/blog/building-better-ai-benchmarks-how-many-raters-are-enough/][Building better AI benchmarks: How many raters are enough?]] #Evaluation
+ [[https://huggingface.co/blog/tiiuae/falcon-perception][Falcon Perception]] #OCR #Image #Segmentation
+ [[https://huggingface.co/blog/trl-v1][TRL v1.0: Post-Training Library Built to Move with the Field]] #Postraining
+ [[https://huggingface.co/blog/ibm-granite/granite-4-vision][Granite 4.0 3B Vision: Compact Multimodal Intelligence for Enterprise Documents]] #Charts #Tables
+ [[https://huggingface.co/blog/gemma4][Welcome Gemma 4: Frontier multimodal intelligence on device]] #Gemma #Pablo #Elena
+ [[https://pyimagesearch.com/2026/01/26/sam-3-concept-based-visual-understanding-and-segmentation/][SAM 3: Concept-Based Visual Understanding and Segmentation - PyImageSearch]] #SemanticSegmentation
+ [[https://pyimagesearch.com/2026/04/06/agentic-ai-vision-system-object-segmentation-with-sam-3-and-qwen/][Agentic AI Vision System: Object Segmentation with SAM 3 and Qwen - PyImageSearch]] #SemanticSegmentation #Agents
+ [[https://pyimagesearch.com/2023/06/26/detr-breakdown-part-3-architecture-and-details/][DETR Breakdown Part 3: Architecture and Details - PyImageSearch]] #ObjectDetection
+ [[https://pyimagesearch.com/2025/01/06/anomaly-detection-how-to-find-outliers-using-the-grubbs-test][Anomaly Detection: How to Find Outliers Using the Grubbs Test - PyImageSearch]] #AnomalyDetection #SpectralGeo
+ [[https://pyimagesearch.com/2025/10/27/build-a-vlc-playlist-generator-with-smolvlm-for-video-highlight-tagging][Build a VLC Playlist Generator with SmolVLM for Video Highlight Tagging - PyImageSearch]] #VLM #VideoTagging
+ [[https://pyimagesearch.com/2025/05/26/ai-for-healthcare-fine-tuning-googles-paligemma-2-for-brain-tumor-detection][AI for Healthcare: Fine-Tuning Google&#039;s PaliGemma 2 for Brain Tumor Detection - PyImageSearch]] #VLM #FineTuning
+ [[https://miguelguerrero.eu/article-synthetic-personas-spain.html][Spain Is Not a Translation Problem: Building Frontier AI That Understands the Country It Serves - Miguel Guerrero]] #Personas
+ [[https://huggingface.co/blog/Nicolas-BZRD/bidirlm-release][BidirLM: Turning Generative LLMs into the Best Open-Source Omnimodal Encoders]] #Encoders
+ [[https://arxiv.org/abs/2405.09768][2405.09768 Evaluating Text-to-Speech Synthesis from a Large Discrete Token-based Speech Language Model]] #Anonimization #Sara
+ [[https://docs.liquid.ai/examples/customize-models/car-maker-identification][Fine tuning LFM2-VL to identify car makers from images - Liquid Docs]] #VLM #FineTuning #Elena
+ [[https://huggingface.co/blog/multimodal-sentence-transformers][Multimodal Embedding &amp; Reranker Models with Sentence Transformers]] #Embedding #MultiModal
+ [[https://www.softcatala.org/la-intelligencia-artificial-al-vostre-ordinador-personal/models-dintelligencia-artificial-en-catala-per-usar-en-local/][Models d&#039;intel·ligència artificial en català per a usar en local - Softcatalà]] #Júlia #Catalán #Evaluación
+ [[https://www.sciencedirect.com/science/article/pii/S1350946226000273][Quantification of retinal microvascular imaging features from fundus photos in ocular and systemic disease: a framework for standardization]] #Retina #Elena #David
+ [[https://blog.langchain.com/the-anatomy-of-an-agent-harness/][The Anatomy of an Agent Harness]] #Harness #Pablo
+ [[https://llm-as-a-verifier.notion.site/][Notion]] #Evaluation
+ [[https://pubmed.ncbi.nlm.nih.gov/41533847/][Neurosymbolic AI Framework for Explainable Retinal Disease Classification From OCT Images - PubMed]] #NeurosymbolicAI #Retina
+ [[https://huggingface.co/blog/ibm-research/vakra-benchmark-analysis][Inside VAKRA: Reasoning, Tool Use, and Failure Modes of Agents]] #Júlia #Benchmark
+ [[https://huggingface.co/blog/FINAL-Bench/darwin-gpqa][&quot;Darwin-27B-Opus: Surpassing the Foundation Model Without Training&quot;]] #ModelMerge
+ [[https://huggingface.co/blog/nielsr/ocr-papers-jobs][How we OCR&#39;ed 30,000 papers using Codex, open OCR models and Jobs]] #OCR
+ [[https://huggingface.co/blog/train-multimodal-sentence-transformers][Training and Finetuning Multimodal Embedding &amp; Reranker Models with Sentence Transformers]] #MultiModal #Embedding #Retrieval
+ [[https://www.nature.com/articles/s41746-026-02607-4][Seven deadly sins in artificial intelligence for digital medicine | npj Digital Medicine]] #Medicine #Risks
+ [[https://huggingface.co/blog/nvidia/nemotron-ocr-v2][Building a Fast Multilingual OCR Model with Synthetic Data]] #OCR
+ [[https://netflixtechblog.com/evaluating-netflix-show-synopses-with-llm-as-a-judge-6269251e6f28][Evaluating Netflix Show Synopses with LLM-as-a-Judge]] #LLMasaJudge
+ [[https://arxiv.org/abs/2503.23451][2503.23451 Beyond Academic Benchmarks: Critical Analysis and Best Practices for Visual Industrial Anomaly Detection]] #AnomalyDetection #SpectralGeo
+ [[https://pub.sakana.ai/ssot/][String Seed of Thought: Prompting LLMs for Distribution-Faithful and Diverse Generation]] #Prompting
+ [[https://mlechner.substack.com/p/quantized-neural-networks-the-only][Quantized Neural Networks: The Only Guide You Need]] #Quantization
+ [[https://raw.works/rlms-are-the-new-reasoning-models/][RLMs are the new reasoning models]] #RecursiveLanguageModels #Júlia
+ [[https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2847679][Large Language Model Performance and Clinical Reasoning Tasks]] #LLM #Medicine
+ [[https://x.com/Vtrivedy10/article/2041927488918413589][Better Harness: A Recipe for Harness Hill-Climbing with Evals]] #Harness
+ [[https://www.nature.com/articles/s41586-024-08328-6][Accurate predictions on small data with a tabular foundation model | Nature]] #TabularData
+ [[https://arxiv.org/abs/2510.01934][2510.01934 Foundation Visual Encoders Are Secretly Few-Shot Anomaly Detectors]] #AnomalyDetection #SpectralGeo #David
+ [[https://towardsdatascience.com/logic-explained-networks-d81c8d119bde/][Logic Explained Networks | Towards Data Science]] #NeurosymbolicAI
+ [[https://arxiv.org/abs/2604.09497][2604.09497 BERT-as-a-Judge: A Robust Alternative to Lexical Methods for Efficient Reference-Based LLM Evaluation]] #Evaluation
+ [[https://machinelearningmastery.com/beyond-vector-search-building-a-deterministic-3-tiered-graph-rag-system/][Beyond Vector Search: Building a Deterministic 3-Tiered Graph-RAG System - MachineLearningMastery.com]] #Pablo #GraphRAG
+ [[https://huggingface.co/blog/KBLab/easyaligner][easyaligner: Forced alignment of text and audio, made easy]] #Audio #Sara #Alignment
+ [[https://huggingface.co/openai/privacy-filter][openai/privacy-filter · Hugging Face]] #Anonimization #Sara
+ [[https://vision-banana.github.io/][Vision Banana | Google DeepMind]] #GeneralistVisionLearner
+ [[https://uwspace.uwaterloo.ca/items/dc44caa2-f092-49d1-b527-da3a30097367][Benchmarks, Data, and Evaluation for Robust Retrieval and Retrieval-Augmented Generation on Heterogeneous Domains and Languages]] #Júlia
+ [[https://huggingface.co/blog/openai-privacy-filter-web-apps][How to build scalable web apps with OpenAI&#39;s Privacy Filter]] #Anonimization
+ [[https://huggingface.co/blog/nvidia/nemotron-3-nano-omni-multimodal-intelligence][Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents]] #OmniModel #David #Elena
+ [[https://huggingface.co/blog/nielsr/gemini-community-science][Running AI agents to automate outreach at scale]] #Agents #Workflows
+ [[https://huggingface.co/blog/deepseekv4][DeepSeek-V4: a million-token context that agents can actually use]] #Models
+ [[https://princeton-computational-imaging.github.io/Telescope/][Telescope: Learnable Hyperbolic Foveation]] #ObjectDetection #SmallObjects
+ [[https://gepa-ai.github.io/gepa/blog/2026/02/18/introducing-optimize-anything/][optimize_anything: A Universal API for Optimizing any Text Parameter - GEPA]] #GEPA #PromptOptimization
+ [[https://huggingface.co/blog/ibm-granite/granite-4-1][Granite 4.1 LLMs: How They’re Built]] #Models
+ [[https://huggingface.co/blog/hugging-science/sarlo-80-sar-optic-language-dataset][SARLO-80: Worldwide Slant SAR Language Optic Dataset at 80 cm Resolution]] #SatelliteImages
+ [[https://huggingface.co/blog/evaleval/eval-costs-bottleneck][AI evals are becoming the new compute bottleneck]] #Evaluation #Benchmarks
+ [[https://huggingface.co/blog/AmelieSchreiber/faster-pha][Faster Persistent Homology Alignment and Protein Complex Clustering with ESM-2 and Persistence Landscapes]] #Proteins #PersistentHomology



** Marzo 2026

+ [[https://huggingface.co/blog/ibm-granite/granite-4-speech][Granite 4.0 1B Speech: Compact, Multilingual, and Built for the Edge]] #ASR
+ [[https://huggingface.co/blog/nvidia/nemo-retriever-agentic-retrieval][Beyond Semantic Similarity: Introducing NVIDIA NeMo Retriever’s Generalizable Agentic Retrieval Pipeline]] #Retrival #Agents
+ [[https://www.draeger.com/Content/Documents/Content/ECRI-Top-10-Health-Technology-Hazards-for-2026-Executive-Brief.pdf][Top 10 Health Technology Hazards for 2026]] #Pablo #BBVA
+ [[https://www.aboutamazon.com/news/retail/amazon-health-ai-agent-one-medical?utm_source=alphasignal&utm_campaign=2026-03-11&lid=UdTMmoi9N45XuDKw][Amazon launches Health AI agent on Amazon website and app with free 24/7 access to virtual care for Prime members]] #Pablo #Health
+ [[https://arxiv.org/abs/2009.10625][Curriculum Learning with Diversity for Supervised Computer Vision Tasks]] #CurriculumLearning #Joaquin
+ [[https://ctxt.es/es/20260201/Culturas/52080/inteligencia-artificial-jose-l-aznarte-generativo-matematicas-alucinaciones-el-ministerio-turing.htm?utm_campaign=lecturas-9-de-febrero&utm_medium=email&utm_source=acumbamail][¿Acaso da igual?]] #CIAIS
+ [[https://huggingface.co/blog/MaziyarPanahi/protein-ai-landscape][The ML Engineer's Guide to Protein AI]] #AlphaFold
+ [[https://huggingface.co/Cannae-AI/MedicalLlama3.2-vision-11B-IT][MedicalLlama3.2-11B-IT]] #Elena #MLLM
+ [[https://research.google/blog/where-wild-things-roam-identifying-wildlife-with-speciesnet/][Where wild things roam: Identifying wildlife with SpeciesNet]] #WildLife #ObjectDetection
+ [[https://research.google/blog/how-ai-trained-on-birds-is-surfacing-underwater-mysteries/][How AI trained on birds is surfacing underwater mysteries]] #TransferLearning #Audio #Embeddings
+ [[https://encyclopediaworld.github.io/howaiworks/index.html][How AI Works — An Interactive History]] #IA
+ [[https://huggingface.co/OpenMed/OpenMed-PII-Spanish-SnowflakeMed-Large-568M-v1][OpenMed/OpenMed-PII-Spanish-SnowflakeMed-Large-568M-v1 · Hugging Face]] #Anonimisation
+ [[https://research.google/blog/teaching-ai-to-read-a-map/][Teaching AI to read a map]] #MLLM
+ [[https://www.kaggle.com/writeups/cdeotte/xgboost-tips-and-tricks][XGBoost Tips and Tricks | Kaggle]] #XGBOOST #IA
+ [[https://huggingface.co/blog/moe-transformers][Mixture of Experts (MoEs) in Transformers]] #MOE
+ [[https://huggingface.co/blog/Photoroom/prx-part3][PRX Part 3 — Training a Text-to-Image Model in 24h!]] #TextToImage
+ [[https://arxiv.org/abs/2603.06578v1][2603.06578v1 Multimodal Large Language Models as Image Classifiers]] #MLLM #Elena
+ [[https://arxiv.org/abs/2505.02428][2505.02428 Can LLM-Simulated Practice and Feedback Upskill Human Counselors? A Randomized Study with 90+ Novice Counselors]] #Pablo #LLM
+ [[https://www.sophielwang.com/blog/jpeg][Sophie Wang]] #JPEG #Compression
+ [[https://research.google/blog/exploring-the-feasibility-of-conversational-diagnostic-ai-in-a-real-world-clinical-study/][Exploring the feasibility of conversational diagnostic AI in a real-world clinical study]] #Pablo
+ [[https://blog.jxmo.io/p/how-to-train-the-best-embedding-model][How to train the best embedding model in the world]] #Embeddings
+ [[https://wheremachinesthink.substack.com/p/the-case-for-world-models-part-i][The Case For World Models, Part I: The Neuroscientific Reason]] #WorldModels
+ [[https://llm-vulnerability.github.io/][ACL 2024 Tutorial: Vulnerabilities of Large Language Models to Adversarial Attacks]] #AdversarialAttacks
+ [[https://ai.meta.com/research/publications/omnilingual-mt-machine-translation-for-1600-languages/][Omnilingual MT: Machine Translation for 1,600 Languages]] #Translation #ChistERA
+ [[https://arxiv.org/abs/2602.13367][2602.13367 Nanbeige4.1-3B: A Small General Model that Reasons, Aligns, and Acts]] #Julia
+ [[https://www.blackhc.net/essays/future_of_software/][Andreas Kirsch | The Flawed Ephemeral Software Hypothesis]] #Software #IA
+ [[https://huggingface.co/Qwen/Qwen3-Omni-30B-A3B-Thinking][Qwen/Qwen3-Omni-30B-A3B-Thinking · Hugging Face]] #OmniModel #Reasoning
+ [[https://www.kaggle.com/blog/community-hackathons][Introducing Community Hackathons | Kaggle]] #Hackaton #IA
+ [[https://huggingface.co/spaces/la-leaderboard/la-leaderboard][La Leaderboard - a Hugging Face Space by la-leaderboard]] #Júlia
+ [[https://emerge-lab.github.io/papers/an-unsolicited-guide-to-good-research.pdf][An unsolicited guide to good research]] #PhD
+ [[https://huggingface.co/blog/nvidia/domain-specific-embedding-finetune][Build a Domain-Specific Embedding Model in Under a Day]] #Pablo #Embedding
+ [[https://github.com/nv-tlabs/kimodo][GitHub - nv-tlabs/kimodo: Official implementation of Kimodo, a kinematic motion diffusion model for high-quality human(oid) motion generation. · GitHub]] #LSEAvatar
+ [[https://huggingface.co/blog/OpenMed/synthvision][SynthVision: Building a 110K Synthetic Medical VQA Dataset with Cross-Model Validation]] #SyntheticData #Elena
+ [[https://arxiv.org/abs/2602.16800][2602.16800 Large-scale online deanonymization with LLMs]] #Deanonymization
+ [[https://github.com/oracle-devrel/oracle-ai-developer-hub/blob/main/notebooks/oracle_image_similarity_openclip.ipynb][oracle-ai-developer-hub/notebooks/oracle_image_similarity_openclip.ipynb at main · oracle-devrel/oracle-ai-developer-hub · GitHub]] #AnomalyDetection #SpectralGeo
+ [[https://sakana.ai/ai-scientist-nature/][The AI Scientist: Towards Fully Automated AI Research, Now Published in &lt;i&gt;Nature&lt;/i&gt;]] #IA
+ [[https://cohere.com/blog/transcribe][Cohere Transcribe: state-of-the-art speech recognition]] #ASR
+ [[https://developers.redhat.com/articles/2025/08/08/ollama-vs-vllm-deep-dive-performance-benchmarking#][Ollama vs. vLLM: A deep dive into performance benchmarking]] #Pablo
+ [[https://blog.google/innovation-and-ai/technology/health/med-gemma-impact-challenge/][Announcing the winners of the MedGemma Impact Challenge]] #Elena
+ [[https://hamel.dev/blog/posts/revenge/][The Revenge of the Data Scientist – Hamel’s Blog - Hamel Husain]] #Evaluation
+ [[https://mistral.ai/news/voxtral-tts][Speaking of Voxtral | Mistral AI]] #TTS #Anonymization
+ [[https://x.com/antoine_chaffin/status/2037195994081673316][Late interaction models have no LIMIT: a story about benchmarks, bugs and better retrieval]] #Retrieval #Pablo


** Febrero 2026
+ [[https://huggingface.co/blog/nvidia/nemotron-colembed-v2][Nemotron ColEmbed V2: Raising the Bar for Multimodal Retrieval with ViDoRe V3’s Top Model]] #Embedding #VisualRAG
+ [[https://research.google/blog/how-ai-agents-can-redefine-universal-design-to-increase-accessibility/][How AI tools can redefine universal design to increase accessibility]] #Accesibilidad
+ [[https://github.com/Kugelaudio/kugelaudio-open][Kugelaudio/kugelaudio-open: Open-source text-to-speech for European languages with voice cloning]] #TextToSpeech #Anonimization


** Enero 2026

+ [[https://magazine.sebastianraschka.com/p/state-of-llms-2025][The State Of LLMs 2025: Progress, Problems, and Predictions]] #LLMs
+ [[https://www.wsj.com/tech/ai/ai-chatbot-psychosis-link-1abf9d57?st=9WhyNw&reflink=desktopwebshare_permalink][AI Chatbots Linked to Psychosis, Say Doctors]] #Pablo #PrevenIA
+ [[https://airisk.mit.edu/][The MIT AI Risk Repository]] #CIAIS
+ [[https://www.cs.cmu.edu/~pavlo/blog/2026/01/2025-databases-retrospective.html][Databases in 2025: A Year in Review // Blog // Andy Pavlo - Carnegie Mellon University]] #Databases
+ [[https://huggingface.co/blog/nvidia/llama-nemotron-vl-1b][Small Yet Mighty: Improve Accuracy In Multimodal Search and Visual Document Retrieval with Llama Nemotron RAG Models]] #MultiModalRetrieval #Pablo
+ [[https://hamel.dev/notes/llm/evals/flashcards/?ajs_uid=720146][Evals Flashcards – Hamel’s Blog - Hamel Husain]] #Evaluation

+ [[https://github.com/galilai-group/lejepa?tab=readme-ov-file][galilai-group/lejepa]] #SelfSupervisedLearning #David #OPTRetina
+ [[https://arxiv.org/abs/2506.08276][LEANN: A Low-Storage Vector Index]] #VectorDatabase #Pablo #PrevenIA
+ [[https://ltx.io/model][Multimodal Model For Generative Creation | LTX Model]] #VideoGeneration
+ [[https://futureofwork.saltlab.stanford.edu/][Future of Work with AI Agents]] #HumanAgentCollaboration
+ [[https://qwen.ai/blog?id=qwen3-vl-embedding][Qwen]] #MultiModalRetrieval #Reranking #BBVA
+ [[https://colab.research.google.com/github/huggingface/trl/blob/main/examples/notebooks/grpo_trl_lora_qlora.ipynb][grpo_trl_lora_qlora.ipynb - Colab]] #GRPO #Reasoning #ReinforcementLearning
+ [[https://huggingface.co/Supertone/supertonic-2][Supertone/supertonic-2 · Hugging Face]] #TTS #BBVA
+ [[https://lemas-project.github.io/LEMAS-Project/][LEMAS Project Page]] #TTS #BBVA
+ [[https://docs.ultralytics.com/models/yolo26/][Ultralytics YOLO26 - Ultralytics YOLO Docs]] #ObjectDetection #Joaquin #OpenEndedObjectDetection
+ [[https://research.google/blog/next-generation-medical-image-interpretation-with-medgemma-15-and-medical-speech-to-text-with-medasr/][Next generation medical image interpretation with MedGemma 1.5 and medical speech to text with MedASR]] #Elena #BBVA #David #OPTRetina #Audio
+ [[https://hunspell.github.io/][Hunspell: About]] #SpellChecking #CienciaEnClaro #Mirari
+ [[https://arxiv.org/abs/2601.08620][2601.08620 ViDoRe V3: A Comprehensive Evaluation of Retrieval Augmented Generation in Complex Real-World Scenarios]] #Júlia #RAG #Dataset
+ [[https://github.com/NVIDIA-NeMo/DataDesigner][NVIDIA-NeMo/DataDesigner: 🎨 NeMo Data Designer: A general library for generating high-quality synthetic data from scratch or based on seed data.]] #Júlia #SyntheticData
+ [[https://arxiv.org/abs/2512.15921][In search of truth: Evaluating concordance of AI-based anatomy segmentation models]] #Segmentation #Joaquin
+ [[https://arxiv.org/abs/2509.20354][EmbeddingGemma: Powerful and Lightweight Text Representations]] #Embedding #Multilingual #BBVA
+ [[https://arxiv.org/abs/2509.01092][REFRAG: Rethinking RAG based Decoding]] #RAG
+ [[https://blog.google/innovation-and-ai/technology/developers-tools/translategemma/][TranslateGemma: A new family of open translation models]] #Traducción #BBVA
+ [[https://developers.googleblog.com/a-guide-to-fine-tuning-functiongemma/][A Guide to Fine-Tuning FunctionGemma - Google Developers Blog]] #Júlia #FunctionCalling
+ [[https://arxiv.org/abs/2409.08107][[2409.08107] WhisperNER: Unified Open Named Entity and Speech Recognition]] #Anonimization
+ [[https://dl.acm.org/doi/abs/10.1145/3769102.3770609][Safeguarding Privacy in Edge Speech Understanding with Tiny Foundation Models | Proceedings of the Tenth ACM/IEEE Symposium on Edge Computing]] #Anonimization
+ [[https://ieeexplore.ieee.org/abstract/document/11005306][AudioCensorNet: A multilingual audio censoring model based on whisper for generating censored video | IEEE Conference Publication | IEEE Xplore]] #Anonimisation
+ [[https://aclanthology.org/N19-2025/][Audio De-identification - a New Entity Recognition Task - ACL Anthology]] #Anonimization
+ [[https://github.com/microsoft/VibeVoice/tree/main][microsoft/VibeVoice: Open-Source Frontier Voice AI]] #ASR #TTS
+ [[https://qwen.ai/blog?id=qwen3tts-0115][Qwen]] #TTS
+ [[https://medsam2.github.io/][MedSAM2: Segment Anything in 3D Medical Images and Videos]] #Segmentation #Joaquin
+ [[https://huggingface.co/papers/2601.10880?utm_source=digest-papers&utm_medium=email&utm_campaign=2026-01-20][Paper page - Medical SAM3: A Foundation Model for Universal Prompt-Driven Medical Image Segmentation]] #Segmentation #Joaquin
+ [[https://aclanthology.org/2025.bionlp-1.28/][Overcoming Data Scarcity in Named Entity Recognition: Synthetic Data Generation with Large Language Models - ACL Anthology]] #DataGeneration #Anonimization #NER
+ [[https://www.protecto.ai/blog/best-ner-models-for-pii-identification/][Comparing Best NER Models For PII Identification]] #Anonimization
+ [[https://research.google/blog/introducing-gist-the-next-stage-in-smart-sampling/][Introducing GIST: The Next Stage in Smart Sampling | Google Research]] #Joaquin #DataSelection
+ [[https://github.com/aiming-lab/SimpleMem][aiming-lab/SimpleMem: SimpleMem: Efficient Lifelong Memory for LLM Agents]] #Pablo #Memory
+ [[https://arxiv.org/html/2502.17513v2][Int2Int: a framework for mathematics with transformers]] #RepresentationLearning
+ [[https://huggingface.co/blog/lightonai/lightonocr-2][LightOnOCR-2-1B: a lightweight high-performance end-to-end OCR model family]] #OCR


* Lecturas del year 2025
** Diciembre 2025

+ [[https://huggingface.co/papers/2512.20182][FaithLens: Detecting and Explaining Faithfulness Hallucination]] #Hallucinations #Pablo
+ [[https://paulabartabajo.substack.com/p/fine-tuning-lfm2-350m-for-browser][Fine-tuning a Small Language Model for browser control with GRPO and OpenEnv]] #ReinforcementLearning
+ [[https://github.com/aishwaryanr/awesome-generative-ai-guide/tree/main/free_courses/agentic_ai_crash_course][Agentic AI Crash Course]] #Agents
+ [[https://arxiv.org/abs/2505.08414][An integrated language-vision foundation model for conversational diagnostics and triaging in primary eye care]] #elena #optretina
+ [[https://huggingface.co/blog/ServiceNow-AI/aprielguard][AprielGuard: A Guardrail for Safety and Adversarial Robustness in Modern LLM Systems]] #Pablo #GuardRails
